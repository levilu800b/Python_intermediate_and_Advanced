...
#
# Example Input {"Monday": 12, "Tuesday": 14, "Wednesday": 15, "Thursday": 14, "Friday": 21, "Saturday": 22,
# "Sunday": 24} Example Output {'Monday': 53.6, 'Tuesday': 57.2, 'Wednesday': 59.0, 'Thursday': 57.2, 'Friday': 69.8,
# 'Saturday': 71.6, 'Sunday': 75.2} Hint Use the keyword method for starting the Dictionary comprehension and fill in
# the relevant parts.
#
...
# eval() converts correctly formatted string into a dictionary
