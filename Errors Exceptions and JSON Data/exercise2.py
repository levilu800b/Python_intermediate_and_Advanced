# Instructions
# We've got some buggy code, try running the code. The code will crash and give you a KeyError. This is
# because some of the posts in the facebook_posts don't have any "Likes".
#
# Objective
...
# [{'Likes': 21, 'Comments': 2}, {'Likes': 13, 'Comments': 2, 'Shares': 1}, {'Likes': 33, 'Comments':
